...
**Bathpelagics**\
All bathypelagic fish stay at the dvm depth during daytime ($z_{\mathrm{loc},\mathrm{day},i} = z_{\mathrm{dvm}}$). At night, the small- and medium-size classes are always at surface ($z_{\mathrm{loc},\mathrm{night},i} = 0$). Half of large-size classes are in the surface water ($z_{\mathrm{loc},\mathrm{night},i} = 0$), and the another half in midwater ($z_{\mathrm{loc},\mathrm{night},i} = z_{\mathrm{dvm}}$).
