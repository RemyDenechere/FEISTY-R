...
The model is first run with the default 3-functional group parameters,
...
p <- setupBasic(szprod = 70,   # small mesozooplankton production
                ...
                bprodin  = 50, # benthos production
                depth  = 200,  # water column depth [m]
...
out1 <- simulateFEISTY(p=p,  times=seq(0, 500, length.out=500),bCust=T)
