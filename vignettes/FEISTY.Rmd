...
The model can now be run for all parameter sets; the result for the last
20 years are shown.

```{r, fig.width=8, fig.height=8}
out1 <- simulateFEISTY(p=p,  times=seq(0, 200, length.out=1000),bCust=T)
out2 <- simulateFEISTY(p=p, times=seq(0, 200, length.out=1000),bCust=T)
out3 <- simulateFEISTY(p=p, times=seq(0, 200, length.out=1000),bCust=T)
