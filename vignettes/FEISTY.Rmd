...
\begin{equation}
  \omega_i = \omega_0 + \tau \cdot \log_{10}\left(\frac{m_{\mathrm{c},i}}{m_{\mathrm{c},1}}\right)
\end{equation}

where $i$ represents each organisms including all resources and fish. Note, for benthic resources, $\omega_i = \omega_0$ to make them stay nearly at the bottom.
...
\begin{equation}
  \theta_{\mathrm{\zeta},\mathrm{x},i} = \frac{\theta_{\mathrm{\zeta},\mathrm{x},i}}{\sum\limits_{i} \theta_{\mathrm{\zeta},\mathrm{x},i}}
\end{equation}

x is either day or night. $z_{\mathrm{loc}}$ is the depth that the maximum biomass is.
...
**Large pelagics**\
The large-size classes of large pelagic fish are split into two groups: half of them are always in the pelagic zone, and 

**Bathypelagics**\
Bathypelagic fish stay at the dvm depth, bottom or pelagic zone, depending on the water column depth and photic conditions
